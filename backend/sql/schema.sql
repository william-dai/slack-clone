...
CREATE TABLE users(id UUID UNIQUE PRIMARY KEY DEFAULT gen_random_uuid(), name VARCHAR(32), email VARCHAR(32), pass VARCHAR(64), role VARCHAR(32), workspace VARCHAR(32), status VARCHAR(32));
