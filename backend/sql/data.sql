...
INSERT INTO message (channelid, createdby, createdtime, content, reactions) SELECT id, 'Nathan', '2021-07-20 11:11:11.111', 'DM test string.', 'Laugh' FROM channel WHERE name = 'Nathan';
INSERT INTO message (channelid, createdby, createdtime, content, reactions) SELECT id, 'Bella', '2021-07-20 11:11:11.111', 'DM test string 2.', 'Laugh' FROM channel WHERE name = 'Bella';
